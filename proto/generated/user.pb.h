...
template<> ::user::DeleteUserRequest* Arena::CreateMaybeMessage<::user::DeleteUserRequest>(Arena*);
template<> ::user::DeleteUserResponse* Arena::CreateMaybeMessage<::user::DeleteUserResponse>(Arena*);
template<> ::user::GetUserRequest* Arena::CreateMaybeMessage<::user::GetUserRequest>(Arena*);
template<> ::user::ListUsersRequest* Arena::CreateMaybeMessage<::user::ListUsersRequest>(Arena*);
template<> ::user::ListUsersResponse* Arena::CreateMaybeMessage<::user::ListUsersResponse>(Arena*);
template<> ::user::UpdateUserRequest* Arena::CreateMaybeMessage<::user::UpdateUserRequest>(Arena*);
...
class UpdateUserRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:user.UpdateUserRequest) */ {
 public:
...
class DeleteUserRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:user.DeleteUserRequest) */ {
 public:
...
class ListUsersRequest final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:user.ListUsersRequest) */ {
 public:
...
class ListUsersResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:user.ListUsersResponse) */ {
 public:
...
class DeleteUserResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:user.DeleteUserResponse) */ {
 public:
...
inline const ::user::User& UserResponse::_internal_user() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::user::User&>(
      ::user::_User_default_instance_);
}
